 ...
 *@size: size of array
 *@left: starting subset of array
 *@right: ending subset of array
 *
 ...
 * @right: ending index of array partitio to order
 *
 ...
 *
 *
 * Description: uses lomuto partition scheme.Prints array
